...
export type Order = {
    ...
    shipping_address: Record<string, AddressField> | null;
    billing_address: Record<string, AddressField> | null;
...
// Define a more specific type to replace 'any'
export type AddressField = string | number | boolean | null | undefined;